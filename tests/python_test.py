...
'''
Test the flask server with python code by atttempting to make a plot out of the data received.
...
#attempt to make a plot out of the data from the serer
makePlot( array(received['salt']), array(received['lonp']), array(received['latp']) )
